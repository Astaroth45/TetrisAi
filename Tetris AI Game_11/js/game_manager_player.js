    ...
    function onKeyDown(event){
        ...
        switch(event.which){
            case 32: // spacebar /drop piece
                ...
                break;
            case 40: // down arrow / piece down 1 square
                gravityTimer.resetForward(500);
                break;
            case 37: //left arrow / piece left 1 square
                if(workingPiece.canMoveLeft(grid)){
                    workingPiece.moveLeft(grid);
                    redrawGridCanvas();
                }
                break;
            case 39: //right arrow / piece right 1 square
                if(workingPiece.canMoveRight(grid)){
                    workingPiece.moveRight(grid);
                    redrawGridCanvas();
                }
                break;
            case 90: // Z key / rotate piece
